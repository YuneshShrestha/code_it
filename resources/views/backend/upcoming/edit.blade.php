                   ...
                   <div class="card-body">
                        ...
                        <form action="/upcoming/{{ $upcoming->id }}" method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <input id="date" class="form-control" type="date" name="date" placeholder="eg. 2021-05-17 " value="{{ $upcoming->date }}" required>
                            </div>
                            @error('date')
                                <p class="text-danger">
                                    {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <input id="time" class="form-control" type="time" name="time" placeholder="eg. 2021-05-17 " value="{{ $upcoming->time }}" required>
                            </div>
                            @error('time')
                                <p class="text-danger">
                                    {{ $message }}
                            ...
                            <div class="form-group">
                                ...
                                <select id="class_type" class="form-control" name="class_type">
                                  <option value="Physical" {{ 'Physical'==$upcoming->class_type ? 'selected' : '' }}>Physical</option>
